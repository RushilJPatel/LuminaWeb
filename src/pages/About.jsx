        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-8 mb-12">
          ...
          <div className="flex-1">
            <p className="text-lg text-slate-700 leading-relaxed mb-4">
              I'm a passionate web developer specializing in creating fast, modern
              websites for small businesses. With a focus on clean code and user
              experience, I help businesses establish a strong online presence.
            </p>
            <p className="text-lg text-slate-700 leading-relaxed">
              My design philosophy centers around simplicity, performance, and
              accessibility. I believe every website should be beautiful,
